      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          <div className="relative">
            <button type="button" className="yt-action-btn" onClick={handleShare} aria-label="共有" title="共有">
          ...
          {/* 保存 */}
          <button type="button" className="yt-action-btn" onClick={handleSave} aria-label="プレイリストに保存" title="プレイリストに保存">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
